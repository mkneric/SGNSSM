      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-1">
            ...
            <li>
              <Link href="/about" className="hover:text-[#2563eb]">À propos</Link>
            </li>
            <li>
              <a href="#" className="hover:text-[#2563eb]">Services</a>
            </li>
            <li>
              <a href="#" className="hover:text-[#2563eb]">Conditions</a>
            </li>
            <li>
              <a href="#" className="hover:text-[#2563eb]">Confidentialité</a>
            </li>
          </ul>
        </div>
